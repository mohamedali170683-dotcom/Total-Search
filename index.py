            ...
            if include_correlation:
                ...
                try:
                    ...
                    if amazon_metrics and amazon_metrics[0].search_volume:
                        # DataForSEO Amazon returns a single volume, not time series.
                        # Generate demo trend based on Google Web pattern for the chart.
                        ...
                        # No real Amazon data — still show demo trend
                        amazon_series = generate_demo_trend(
                            google_web_series, primary_kw, "amazon"
                        )
                        if amazon_series:
